 ...
 * @author Chen
 */
public class RenderAboutBox extends javax.swing.JDialog {

    public RenderAboutBox(java.awt.Frame parent) {
        super(parent);
        initComponents();
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(render.RenderApp.class).getContext().getResourceMap(RenderAboutBox.class);
        setTitle(resourceMap.getString("title")); // NOI18N
        setModal(true);
        setName("aboutBox"); // NOI18N
        setResizable(false);

        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(render.RenderApp.class).getContext().getActionMap(RenderAboutBox.class, this);
